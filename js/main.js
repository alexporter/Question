...
function getReveal(pageIndex)   {
    var revealInfo = [
        {
            html: '<iframe width="200" height="120" src="https://www.youtube.com/embed/2muto1kBPFg?wmode=transparent&rel=0" style="z-index: 0 !important;" frameborder="0" wmode="Opaque"></iframe>',
            value: 7
        },
        {
